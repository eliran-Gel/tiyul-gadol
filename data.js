...
// ── Budget data ──────────────────────────────────────────────────────────────
// כל הסכומים הם ₪ ליום (לינה/אוכל/תחבורה/פעילויות) או ₪ לסך הכל (טיסות/ויזה/ביטוח)
// Low = תקציבן: הוסטל דורמיטורי, אוכל רחוב, אוטובוסים מקומיים
// Mid = ממוצע: חדר פרטי, מסעדות מקומיות, תחבורה נוחה
// High = נוח: מלון 3-4*, רסטורנטים, מוניות/טיסות פנימיות
// שער חליפין בסיס: $1 ≈ ₪3.75 (2024-2025)
var BUDGET_DATA = {
  thailand:    { name:'תאילנד',      emoji:'🇹🇭', accommodation:{low:50, mid:100,high:255},  food:{low:50, mid:88, high:195},  transport:{low:22, mid:52, high:128},  activities:{low:37, mid:85, high:200},   flights:2900, visa:0,    insurancePer30:355, note:'זול מאוד! חוף + Full Moon Party + ספא' },
  vietnam:     { name:'וייטנאם',     emoji:'🇻🇳', accommodation:{low:38, mid:78, high:213},  food:{low:40, mid:78, high:157},  transport:{low:22, mid:52, high:112},  activities:{low:27, mid:62, high:157},   flights:3100, visa:0,    insurancePer30:335, note:'זול + ייחודי + האלונג Bay!' },
  indonesia:   { name:'באלי',        emoji:'🇮🇩', accommodation:{low:53, mid:113,high:298},  food:{low:42, mid:83, high:203},  transport:{low:28, mid:62, high:148},  activities:{low:42, mid:92, high:228},   flights:3300, visa:130,  insurancePer30:340, note:'Beach Clubs + מקדשים + גלישה' },
  cambodia:    { name:'קמבודיה',     emoji:'🇰🇭', accommodation:{low:48, mid:83, high:253},  food:{low:36, mid:74, high:170},  transport:{low:30, mid:57, high:130},  activities:{low:36, mid:71, high:192},   flights:2900, visa:135,  insurancePer30:330, note:'אנגקור וואט + חופי קאמפוט + זול מאד!' },
  japan:       { name:'יפן',         emoji:'🇯🇵', accommodation:{low:110,mid:225,high:545},  food:{low:88, mid:155,high:295},  transport:{low:63, mid:127,high:265},  activities:{low:58, mid:108,high:245},   flights:3800, visa:0,    insurancePer30:425, note:'יוקר + ייחודי = חוויה אחרת לגמרי!' },
  laos:        { name:'לאוס',        emoji:'🇱🇦', accommodation:{low:42, mid:83, high:225},  food:{low:32, mid:63, high:140},  transport:{low:27, mid:57, high:126},  activities:{low:27, mid:71, high:177},   flights:2900, visa:110,  insurancePer30:320, note:'הכי שקט ורגוע בדרום מזרח אסיה' },
  nepal:       { name:'נפאל',        emoji:'🇳🇵', accommodation:{low:52, mid:100,high:248},  food:{low:37, mid:77, high:184},  transport:{low:32, mid:63, high:156},  activities:{low:60, mid:115,high:312},   flights:2500, visa:150,  insurancePer30:340, note:"טרקינג אוורסט + אנפורנה — חוויה מטורפת!" },
  srilanka:    { name:'סרי לנקה',    emoji:'🇱🇰', accommodation:{low:52, mid:100,high:270},  food:{low:37, mid:77, high:184},  transport:{low:32, mid:63, high:156},  activities:{low:46, mid:92, high:227},   flights:2200, visa:60,   insurancePer30:330, note:'חופים + מקדשים + ספארי + קרי!' },
  india:       { name:'הודו',        emoji:'🇮🇳', accommodation:{low:46, mid:100,high:284},  food:{low:37, mid:71, high:177},  transport:{low:27, mid:57, high:142},  activities:{low:37, mid:85, high:213},   flights:1900, visa:150,  insurancePer30:330, note:'ראג׳סתאן + גואה + יוגה + כאוס!' },
  philippines: { name:'פיליפינים',   emoji:'🇵🇭', accommodation:{low:60, mid:117,high:298},  food:{low:50, mid:96, high:206},  transport:{low:32, mid:63, high:156},  activities:{low:42, mid:88, high:220},   flights:3800, visa:0,    insurancePer30:325, note:'Island Hopping + Diving + חופים מהיפים בעולם!' },
  peru:        { name:'פרו',         emoji:'🇵🇪', accommodation:{low:60, mid:117,high:298},  food:{low:56, mid:103,high:220},  transport:{low:42, mid:74, high:184},  activities:{low:78, mid:149,high:369},   flights:5500, visa:0,    insurancePer30:360, note:"מאצ'ו פיצ'ו + Rainbow Mountain" },
  colombia:    { name:'קולומביה',    emoji:'🇨🇴', accommodation:{low:60, mid:124,high:298},  food:{low:50, mid:96, high:206},  transport:{low:37, mid:67, high:163},  activities:{low:60, mid:110,high:291},   flights:5000, visa:0,    insurancePer30:350, note:'מדיין + קרטחנה = קסם!' },
  argentina:   { name:'ארגנטינה',    emoji:'🇦🇷', accommodation:{low:70, mid:149,high:369},  food:{low:60, mid:121,high:255},  transport:{low:50, mid:88, high:220},  activities:{low:70, mid:135,high:326},   flights:4200, visa:0,    insurancePer30:385, note:'Asado + פטגוניה + טנגו' },
  bolivia:     { name:'בוליביה',     emoji:'🇧🇴', accommodation:{low:55, mid:117,high:291},  food:{low:46, mid:96, high:202},  transport:{low:42, mid:81, high:181},  activities:{low:60, mid:117,high:291},   flights:4800, visa:0,    insurancePer30:340, note:'מלחת אוקרוני = הנוף הקסום ביותר!' },
  chile:       { name:"צ'ילה",       emoji:'🇨🇱', accommodation:{low:116,mid:220,high:550},  food:{low:78, mid:149,high:330},  transport:{low:70, mid:135,high:330},  activities:{low:96, mid:206,high:511},   flights:4800, visa:0,    insurancePer30:390, note:'פטגוניה + טורס דל פיינה + הגעיר!' },
  brazil:      { name:'ברזיל',       emoji:'🇧🇷', accommodation:{low:83, mid:174,high:436},  food:{low:64, mid:131,high:291},  transport:{low:55, mid:110,high:255},  activities:{low:78, mid:145,high:365},   flights:4500, visa:0,    insurancePer30:370, note:'ריו + אמזונס + Carnaval!' },
  ecuador:     { name:'אקוודור',     emoji:'🇪🇨', accommodation:{low:64, mid:131,high:330},  food:{low:50, mid:103,high:224},  transport:{low:46, mid:96, high:231},  activities:{low:70, mid:145,high:436},   flights:4500, visa:0,    insurancePer30:350, note:'איי גלפגוס + אמזונס + וולקנים!' },
  mexico:      { name:'מקסיקו',      emoji:'🇲🇽', accommodation:{low:83, mid:160,high:401},  food:{low:64, mid:124,high:277},  transport:{low:55, mid:110,high:255},  activities:{low:70, mid:131,high:330},   flights:3200, visa:0,    insurancePer30:350, note:'קנקון + מאיה + פרמידות + אוכל אדיר!' },
  guatemala:   { name:'גואטמלה',     emoji:'🇬🇹', accommodation:{low:60, mid:124,high:295},  food:{low:46, mid:96, high:202},  transport:{low:37, mid:74, high:181},  activities:{low:60, mid:110,high:255},   flights:3500, visa:0,    insurancePer30:340, note:'אטיטלאן + אנטיגואה = מהיפות בעולם!' },
  costarica:   { name:'קוסטה ריקה',  emoji:'🇨🇷', accommodation:{low:92, mid:170,high:461},  food:{low:74, mid:131,high:298},  transport:{low:55, mid:110,high:305},  activities:{low:83, mid:131,high:397},   flights:3600, visa:0,    insurancePer30:370, note:"ג'ונגל + חלאפות + גלישה + קופים!" },
  australia:   { name:'אוסטרליה',    emoji:'🇦🇺', accommodation:{low:170,mid:295,high:600},  food:{low:96, mid:200,high:370},  transport:{low:78, mid:183,high:400},  activities:{low:96, mid:231,high:500},   flights:4200, visa:1400, insurancePer30:500, note:'Working Holiday Visa! הכי ישראלים בעולם' },
  newzealand:  { name:'ניו זילנד',   emoji:'🇳🇿', accommodation:{low:192,mid:330,high:730},  food:{low:114,mid:231,high:460},  transport:{low:87, mid:188,high:491},  activities:{low:100,mid:200,high:554},   flights:5500, visa:130,  insurancePer30:555, note:'Bungee + Hobbiton + פיורדים = אגדה!' },
  kenya:       { name:'קניה',        emoji:'🇰🇪', accommodation:{low:83, mid:156,high:497},  food:{low:55, mid:92, high:209},  transport:{low:46, mid:92, high:234},  activities:{low:64, mid:117,high:341},   flights:2500, visa:150,  insurancePer30:405, note:'ספארי שווה כל שקל!' },
  tanzania:    { name:'טנזניה',      emoji:'🇹🇿', accommodation:{low:83, mid:156,high:638},  food:{low:55, mid:92, high:220},  transport:{low:50, mid:99, high:284},  activities:{low:64, mid:121,high:369},   flights:2500, visa:150,  insurancePer30:405, note:'סרנגטי + קילמנג׳ארו + זנזיבר!' },
  uganda:      { name:'אוגנדה',      emoji:'🇺🇬', accommodation:{low:74, mid:135,high:880},  food:{low:50, mid:77, high:199},  transport:{low:37, mid:71, high:206},  activities:{low:50, mid:85, high:255},   flights:2800, visa:150,  insurancePer30:400, note:'גורילות הרי (אישור ₪2,625 נפרד) + ריביות!' },
  southafrica: { name:'דרום אפריקה', emoji:'🇿🇦', accommodation:{low:92, mid:184,high:554},  food:{low:74, mid:131,high:284},  transport:{low:74, mid:142,high:397},  activities:{low:78, mid:142,high:440},   flights:3000, visa:0,    insurancePer30:390, note:'ספארי + קייפ טאון = חבילה מושלמת!' },
  namibia:     { name:'נמיביה',      emoji:'🇳🇦', accommodation:{low:96, mid:195,high:582},  food:{low:60, mid:113,high:255},  transport:{low:78, mid:184,high:511},  activities:{low:70, mid:142,high:426},   flights:3200, visa:0,    insurancePer30:390, note:'מדבר נמיב + אטושה + ציד תמונות!' },
  morocco:     { name:'מרוקו',       emoji:'🇲🇦', accommodation:{low:60, mid:135,high:330},  food:{low:50, mid:100,high:200},  transport:{low:38, mid:68, high:170},  activities:{low:46, mid:96, high:230},   flights:1200, visa:0,    insurancePer30:280, note:'הכי קרוב לישראל! סהרה + מדינות + תבלינים' },
  madagascar:  { name:'מדגסקר',      emoji:'🇲🇬', accommodation:{low:83, mid:184,high:476},  food:{low:50, mid:103,high:234},  transport:{low:70, mid:145,high:404},  activities:{low:78, mid:160,high:440},   flights:4200, visa:110,  insurancePer30:390, note:'למורים + ג׳ונגל + חיות שאין בשום מקום!' },
  usa:         { name:'ארה"ב',       emoji:'🇺🇸', accommodation:{low:190,mid:365,high:880},  food:{low:124,mid:206,high:440},  transport:{low:96, mid:184,high:440},  activities:{low:96, mid:184,high:511},   flights:3500, visa:60,   insurancePer30:595, note:'הכי יקר — Road Trip חוסך הרבה!' },
};
