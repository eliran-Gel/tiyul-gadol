...
var BUDGET_DATA = {
  thailand:    { name:'תאילנד',      emoji:'🇹🇭', accommodation:{low:42, mid:105,high:270},  food:{low:42, mid:90, high:185},  transport:{low:21, mid:55, high:130},  activities:{low:33, mid:80, high:195},   flights:2900, visa:0,    insurancePer30:355, note:'זול מאוד! חוף + Full Moon Party + ספא' },
  vietnam:     { name:'וייטנאם',     emoji:'🇻🇳', accommodation:{low:32, mid:80, high:200},  food:{low:33, mid:70, high:150},  transport:{low:16, mid:45, high:105},  activities:{low:27, mid:60, high:165},   flights:3100, visa:0,    insurancePer30:335, note:'זול + ייחודי + האלונג Bay!' },
  indonesia:   { name:'באלי',        emoji:'🇮🇩', accommodation:{low:48, mid:110,high:300},  food:{low:40, mid:85, high:195},  transport:{low:28, mid:65, high:150},  activities:{low:36, mid:85, high:170},   flights:3300, visa:130,  insurancePer30:340, note:'Beach Clubs + מקדשים + גלישה' },
  cambodia:    { name:'קמבודיה',     emoji:'🇰🇭', accommodation:{low:40, mid:85, high:255},  food:{low:35, mid:72, high:162},  transport:{low:25, mid:55, high:125},  activities:{low:30, mid:63, high:178},   flights:2900, visa:135,  insurancePer30:330, note:'אנגקור וואט + חופי קאמפוט + זול מאד!' },
  japan:       { name:'יפן',         emoji:'🇯🇵', accommodation:{low:110,mid:240,high:580},  food:{low:88, mid:158,high:285},  transport:{low:65, mid:128,high:290},  activities:{low:47, mid:114,high:260},   flights:3800, visa:0,    insurancePer30:425, note:'יוקר + ייחודי = חוויה אחרת לגמרי!' },
  laos:        { name:'לאוס',        emoji:'🇱🇦', accommodation:{low:38, mid:80, high:220},  food:{low:30, mid:62, high:135},  transport:{low:25, mid:55, high:120},  activities:{low:25, mid:68, high:165},   flights:2900, visa:110,  insurancePer30:320, note:'הכי שקט ורגוע בדרום מזרח אסיה' },
  nepal:       { name:'נפאל',        emoji:'🇳🇵', accommodation:{low:50, mid:100,high:245},  food:{low:37, mid:78, high:182},  transport:{low:30, mid:65, high:155},  activities:{low:51, mid:112,high:318},   flights:2500, visa:150,  insurancePer30:340, note:"טרקינג אוורסט + אנפורנה — חוויה מטורפת!" },
  srilanka:    { name:'סרי לנקה',    emoji:'🇱🇰', accommodation:{low:50, mid:100,high:265},  food:{low:36, mid:78, high:182},  transport:{low:30, mid:62, high:155},  activities:{low:42, mid:90, high:218},   flights:2200, visa:60,   insurancePer30:330, note:'חופים + מקדשים + ספארי + קרי!' },
  india:       { name:'הודו',        emoji:'🇮🇳', accommodation:{low:42, mid:96, high:276},  food:{low:36, mid:70, high:172},  transport:{low:26, mid:57, high:140},  activities:{low:36, mid:82, high:187},   flights:1900, visa:150,  insurancePer30:330, note:'ראג׳סתאן + גואה + יוגה + כאוס!' },
  philippines: { name:'פיליפינים',   emoji:'🇵🇭', accommodation:{low:55, mid:113,high:295},  food:{low:48, mid:93, high:200},  transport:{low:32, mid:62, high:155},  activities:{low:40, mid:87, high:195},   flights:3800, visa:0,    insurancePer30:325, note:'Island Hopping + Diving + חופים מהיפים בעולם!' },
  peru:        { name:'פרו',         emoji:'🇵🇪', accommodation:{low:62, mid:118,high:295},  food:{low:55, mid:107,high:220},  transport:{low:40, mid:75, high:180},  activities:{low:63, mid:135,high:355},   flights:5500, visa:0,    insurancePer30:360, note:"מאצ'ו פיצ'ו + Rainbow Mountain" },
  colombia:    { name:'קולומביה',    emoji:'🇨🇴', accommodation:{low:58, mid:120,high:290},  food:{low:50, mid:96, high:205},  transport:{low:37, mid:67, high:160},  activities:{low:50, mid:107,high:290},   flights:5000, visa:0,    insurancePer30:350, note:'מדיין + קרטחנה = קסם!' },
  argentina:   { name:'ארגנטינה',    emoji:'🇦🇷', accommodation:{low:72, mid:148,high:365},  food:{low:60, mid:122,high:255},  transport:{low:50, mid:88, high:220},  activities:{low:63, mid:132,high:310},   flights:4200, visa:0,    insurancePer30:385, note:'Asado + פטגוניה + טנגו' },
  bolivia:     { name:'בוליביה',     emoji:'🇧🇴', accommodation:{low:55, mid:118,high:288},  food:{low:45, mid:97, high:202},  transport:{low:40, mid:82, high:180},  activities:{low:45, mid:98, high:280},   flights:4800, visa:0,    insurancePer30:340, note:'מלחת אוקרוני = הנוף הקסום ביותר!' },
  chile:       { name:"צ'ילה",       emoji:'🇨🇱', accommodation:{low:112,mid:218,high:545},  food:{low:78, mid:150,high:335},  transport:{low:70, mid:135,high:335},  activities:{low:85, mid:192,high:465},   flights:4800, visa:0,    insurancePer30:390, note:'פטגוניה + טורס דל פיינה + הגעיר!' },
  brazil:      { name:'ברזיל',       emoji:'🇧🇷', accommodation:{low:82, mid:170,high:430},  food:{low:63, mid:132,high:290},  transport:{low:53, mid:110,high:255},  activities:{low:72, mid:133,high:345},   flights:4500, visa:0,    insurancePer30:370, note:'ריו + אמזונס + Carnaval!' },
  ecuador:     { name:'אקוודור',     emoji:'🇪🇨', accommodation:{low:62, mid:130,high:328},  food:{low:50, mid:104,high:222},  transport:{low:44, mid:96, high:230},  activities:{low:59, mid:130,high:395},   flights:4500, visa:0,    insurancePer30:350, note:'איי גלפגוס + אמזונס + וולקנים!' },
  mexico:      { name:'מקסיקו',      emoji:'🇲🇽', accommodation:{low:80, mid:158,high:398},  food:{low:63, mid:125,high:278},  transport:{low:52, mid:108,high:255},  activities:{low:60, mid:119,high:299},   flights:3200, visa:0,    insurancePer30:350, note:'קנקון + מאיה + פרמידות + אוכל אדיר!' },
  guatemala:   { name:'גואטמלה',     emoji:'🇬🇹', accommodation:{low:57, mid:120,high:285},  food:{low:45, mid:95, high:200},  transport:{low:35, mid:72, high:175},  activities:{low:48, mid:98, high:245},   flights:3500, visa:0,    insurancePer30:340, note:'אטיטלאן + אנטיגואה = מהיפות בעולם!' },
  costarica:   { name:'קוסטה ריקה',  emoji:'🇨🇷', accommodation:{low:88, mid:165,high:455},  food:{low:72, mid:130,high:295},  transport:{low:53, mid:108,high:305},  activities:{low:72, mid:127,high:365},   flights:3600, visa:0,    insurancePer30:370, note:"ג'ונגל + חלאפות + גלישה + קופים!" },
  australia:   { name:'אוסטרליה',    emoji:'🇦🇺', accommodation:{low:165,mid:283,high:585},  food:{low:93, mid:195,high:368},  transport:{low:76, mid:178,high:392},  activities:{low:101,mid:239,high:475},   flights:4200, visa:1400, insurancePer30:500, note:'Working Holiday Visa! הכי ישראלים בעולם' },
  newzealand:  { name:'ניו זילנד',   emoji:'🇳🇿', accommodation:{low:188,mid:325,high:720},  food:{low:112,mid:220,high:455},  transport:{low:85, mid:185,high:480},  activities:{low:95, mid:215,high:495},   flights:5500, visa:130,  insurancePer30:555, note:'Bungee + Hobbiton + פיורדים = אגדה!' },
  kenya:       { name:'קניה',        emoji:'🇰🇪', accommodation:{low:80, mid:155,high:490},  food:{low:54, mid:92, high:208},  transport:{low:46, mid:90, high:230},  activities:{low:65, mid:193,high:352},   flights:2500, visa:150,  insurancePer30:405, note:'ספארי שווה כל שקל!' },
  tanzania:    { name:'טנזניה',      emoji:'🇹🇿', accommodation:{low:82, mid:158,high:635},  food:{low:55, mid:94, high:220},  transport:{low:50, mid:100,high:280},  activities:{low:68, mid:193,high:335},   flights:2500, visa:150,  insurancePer30:405, note:'סרנגטי + קילמנג׳ארו + זנזיבר!' },
  uganda:      { name:'אוגנדה',      emoji:'🇺🇬', accommodation:{low:72, mid:132,high:880},  food:{low:50, mid:78, high:198},  transport:{low:37, mid:70, high:205},  activities:{low:46, mid:160,high:255},   flights:2800, visa:150,  insurancePer30:400, note:'גורילות הרי (אישור ₪2,625 נפרד) + ריביות!' },
  southafrica: { name:'דרום אפריקה', emoji:'🇿🇦', accommodation:{low:93, mid:183,high:550},  food:{low:73, mid:130,high:282},  transport:{low:72, mid:143,high:398},  activities:{low:72, mid:184,high:390},   flights:3000, visa:0,    insurancePer30:390, note:'ספארי + קייפ טאון = חבילה מושלמת!' },
  namibia:     { name:'נמיביה',      emoji:'🇳🇦', accommodation:{low:95, mid:193,high:640},  food:{low:59, mid:113,high:255},  transport:{low:78, mid:185,high:515},  activities:{low:63, mid:144,high:270},   flights:3200, visa:0,    insurancePer30:390, note:'מדבר נמיב + אטושה + ציד תמונות!' },
  morocco:     { name:'מרוקו',       emoji:'🇲🇦', accommodation:{low:52, mid:128,high:320},  food:{low:48, mid:98, high:200},  transport:{low:35, mid:65, high:162},  activities:{low:45, mid:94, high:218},   flights:1200, visa:0,    insurancePer30:280, note:'הכי קרוב לישראל! סהרה + מדינות + תבלינים' },
  madagascar:  { name:'מדגסקר',      emoji:'🇲🇬', accommodation:{low:80, mid:180,high:472},  food:{low:50, mid:102,high:232},  transport:{low:68, mid:143,high:400},  activities:{low:67, mid:145,high:386},   flights:4200, visa:110,  insurancePer30:390, note:'למורים + ג׳ונגל + חיות שאין בשום מקום!' },
  usa:         { name:'ארה"ב',       emoji:'🇺🇸', accommodation:{low:188,mid:358,high:858},  food:{low:122,mid:202,high:435},  transport:{low:94, mid:178,high:435},  activities:{low:86, mid:182,high:472},   flights:3500, visa:60,   insurancePer30:595, note:'הכי יקר — Road Trip חוסך הרבה!' },
};
