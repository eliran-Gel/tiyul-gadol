...
// ── Budget data ──────────────────────────────────────────────────────────────
var BUDGET_DATA = {
  thailand:    { name:'תאילנד',      emoji:'🇹🇭', accommodation:{low:55,mid:140,high:360},  food:{low:55,mid:130,high:280},  transport:{low:25,mid:70,high:180},  activities:{low:40,mid:120,high:280},   flights:2900, visa:0,    insurancePer30:380, note:'זול מאוד! חוף + Full Moon Party + Spa' },
  vietnam:     { name:'וייטנאם',     emoji:'🇻🇳', accommodation:{low:40,mid:110,high:300},  food:{low:45,mid:110,high:220},  transport:{low:30,mid:75,high:160},  activities:{low:30,mid:90,high:220},    flights:3100, visa:0,    insurancePer30:360, note:'זול + ייחודי + האלונג Bay!' },
  indonesia:   { name:'באלי',        emoji:'🇮🇩', accommodation:{low:55,mid:160,high:420},  food:{low:45,mid:120,high:290},  transport:{low:30,mid:85,high:210},  activities:{low:45,mid:130,high:320},   flights:3300, visa:0,    insurancePer30:360, note:'Beach Clubs + מקדשים + הרים' },
  cambodia:    { name:'קמבודיה',     emoji:'🇰🇭', accommodation:{low:60,mid:150,high:400},  food:{low:45,mid:120,high:250},  transport:{low:40,mid:90,high:200},  activities:{low:50,mid:130,high:300},   flights:2900, visa:90,   insurancePer30:350, note:'אנגקור וואט + חופי קאמפוט + זול מאד!' },
  japan:       { name:'יפן',         emoji:'🇯🇵', accommodation:{low:140,mid:360,high:900}, food:{low:120,mid:260,high:500}, transport:{low:80,mid:200,high:500}, activities:{low:80,mid:200,high:400},   flights:3800, visa:0,    insurancePer30:450, note:'יוקר + ייחודי = חוויה אחרת לגמרי!' },
  laos:        { name:'לאוס',        emoji:'🇱🇦', accommodation:{low:45,mid:120,high:320},  food:{low:35,mid:90,high:200},   transport:{low:30,mid:80,high:180},  activities:{low:30,mid:100,high:250},   flights:2900, visa:110,  insurancePer30:340, note:'הכי שקט ורגוע בדרום מזרח אסיה' },
  nepal:       { name:'נפאל',        emoji:'🇳🇵', accommodation:{low:55,mid:140,high:350},  food:{low:40,mid:110,high:260},  transport:{low:35,mid:90,high:220},  activities:{low:100,mid:250,high:600},  flights:2500, visa:150,  insurancePer30:350, note:"טרקינג אוורסט + אנפורנה — חוויה מטורפת!" },
  srilanka:    { name:'סרי לנקה',    emoji:'🇱🇰', accommodation:{low:55,mid:140,high:380},  food:{low:40,mid:110,high:260},  transport:{low:35,mid:90,high:220},  activities:{low:50,mid:130,high:320},   flights:2200, visa:60,   insurancePer30:340, note:'אדם ורווין + הניין + פילים!' },
  india:       { name:'הודו',        emoji:'🇮🇳', accommodation:{low:50,mid:140,high:400},  food:{low:40,mid:100,high:250},  transport:{low:30,mid:80,high:200},  activities:{low:40,mid:120,high:300},   flights:1900, visa:150,  insurancePer30:340, note:'ראג׳סתאן + גואה + יוגה + כאוס!' },
  philippines: { name:'פיליפינים',   emoji:'🇵🇭', accommodation:{low:65,mid:165,high:420},  food:{low:55,mid:135,high:290},  transport:{low:35,mid:90,high:220},  activities:{low:45,mid:125,high:310},   flights:3800, visa:0,    insurancePer30:330, note:'Island Hopping + Diving + חופים מהיפים בעולם!' },
  peru:        { name:'פרו',         emoji:'🇵🇪', accommodation:{low:65,mid:165,high:420},  food:{low:60,mid:145,high:310},  transport:{low:45,mid:105,high:260}, activities:{low:85,mid:210,high:520},   flights:5500, visa:0,    insurancePer30:370, note:"מאצ'ו פיצ'ו + Rainbow Mountain" },
  colombia:    { name:'קולומביה',    emoji:'🇨🇴', accommodation:{low:65,mid:175,high:420},  food:{low:55,mid:135,high:290},  transport:{low:40,mid:95,high:230},  activities:{low:65,mid:155,high:410},   flights:5000, visa:0,    insurancePer30:360, note:'מדיין + קרטחנה = קסם!' },
  argentina:   { name:'ארגנטינה',    emoji:'🇦🇷', accommodation:{low:75,mid:210,high:520},  food:{low:65,mid:170,high:360},  transport:{low:55,mid:125,high:310}, activities:{low:75,mid:190,high:460},   flights:4200, visa:0,    insurancePer30:390, note:'Asado + פטגוניה + טנגו' },
  bolivia:     { name:'בוליביה',     emoji:'🇧🇴', accommodation:{low:60,mid:165,high:410},  food:{low:50,mid:135,high:285},  transport:{low:45,mid:115,high:255}, activities:{low:65,mid:165,high:410},   flights:4800, visa:0,    insurancePer30:350, note:'מלחת אוקרוני = הנוף הקסום ביותר!' },
  chile:       { name:"צ'ילה",       emoji:'🇨🇱', accommodation:{low:125,mid:310,high:775}, food:{low:85,mid:210,high:465},  transport:{low:75,mid:190,high:465}, activities:{low:105,mid:290,high:720},  flights:4800, visa:0,    insurancePer30:400, note:'פטגוניה + טורס דל פיינה + הגעיר!' },
  brazil:      { name:'ברזיל',       emoji:'🇧🇷', accommodation:{low:90,mid:245,high:615},  food:{low:70,mid:185,high:410},  transport:{low:60,mid:155,high:360}, activities:{low:85,mid:205,high:515},   flights:4500, visa:0,    insurancePer30:380, note:'ריו + אמזונס + Carnaval!' },
  ecuador:     { name:'אקוודור',     emoji:'🇪🇨', accommodation:{low:70,mid:185,high:465},  food:{low:55,mid:145,high:315},  transport:{low:50,mid:135,high:325}, activities:{low:75,mid:205,high:615},   flights:4500, visa:0,    insurancePer30:360, note:'איי גלפגוס + אמזונס + וולקנים!' },
  mexico:      { name:'מקסיקו',      emoji:'🇲🇽', accommodation:{low:90,mid:225,high:565},  food:{low:70,mid:175,high:390},  transport:{low:60,mid:155,high:360}, activities:{low:75,mid:185,high:465},   flights:3200, visa:0,    insurancePer30:360, note:'קנקון + מאיה + פרמידות + אוכל אדיר!' },
  guatemala:   { name:'גואטמלה',     emoji:'🇬🇹', accommodation:{low:65,mid:175,high:415},  food:{low:50,mid:135,high:285},  transport:{low:40,mid:105,high:255}, activities:{low:65,mid:155,high:360},   flights:3500, visa:0,    insurancePer30:350, note:'אטיטלאן + אנטיגואה = מהיפות בעולם!' },
  costarica:   { name:'קוסטה ריקה',  emoji:'🇨🇷', accommodation:{low:115,mid:310,high:775}, food:{low:85,mid:205,high:465},  transport:{low:65,mid:175,high:465}, activities:{low:125,mid:310,high:775},  flights:3600, visa:0,    insurancePer30:380, note:"ג'ונגל + חלאפות + גלישה + קופים!" },
  australia:   { name:'אוסטרליה',    emoji:'🇦🇺', accommodation:{low:185,mid:415,high:930}, food:{low:105,mid:225,high:465}, transport:{low:85,mid:205,high:515}, activities:{low:105,mid:260,high:620},  flights:4200, visa:1400, insurancePer30:530, note:'Working Holiday Visa! הכי ישראלים בעולם' },
  newzealand:  { name:'ניו זילנד',   emoji:'🇳🇿', accommodation:{low:210,mid:465,high:1030},food:{low:125,mid:260,high:515}, transport:{low:105,mid:260,high:620},activities:{low:155,mid:360,high:825},  flights:5500, visa:130,  insurancePer30:580, note:'Bungee + Hobbiton + פיורדים = אגדה!' },
  kenya:       { name:'קניה',        emoji:'🇰🇪', accommodation:{low:105,mid:310,high:825}, food:{low:65,mid:155,high:360},  transport:{low:55,mid:155,high:415}, activities:{low:210,mid:515,high:1550}, flights:2500, visa:150,  insurancePer30:420, note:'ספארי שווה כל שקל!' },
  tanzania:    { name:'טנזניה',      emoji:'🇹🇿', accommodation:{low:125,mid:360,high:1240},food:{low:75,mid:185,high:415},  transport:{low:75,mid:205,high:620}, activities:{low:310,mid:775,high:2320}, flights:2500, visa:150,  insurancePer30:420, note:'סרנגטי + קילמנג׳ארו + זנזיבר!' },
  uganda:      { name:'אוגנדה',      emoji:'🇺🇬', accommodation:{low:125,mid:360,high:1240},food:{low:75,mid:185,high:415},  transport:{low:90,mid:245,high:620}, activities:{low:415,mid:930,high:2480}, flights:2800, visa:150,  insurancePer30:410, note:'גורילות הרי + ריביות + ג׳ונגל ירוק!' },
  southafrica: { name:'דרום אפריקה', emoji:'🇿🇦', accommodation:{low:115,mid:310,high:930}, food:{low:85,mid:205,high:465},  transport:{low:85,mid:225,high:620}, activities:{low:125,mid:360,high:1035}, flights:3000, visa:0,    insurancePer30:400, note:'ספארי + קייפ טאון = חבילה מושלמת!' },
  namibia:     { name:'נמיביה',      emoji:'🇳🇦', accommodation:{low:115,mid:310,high:930}, food:{low:70,mid:175,high:390},  transport:{low:85,mid:260,high:720}, activities:{low:105,mid:310,high:825},  flights:3200, visa:0,    insurancePer30:400, note:'מדבר נמיב + אטושה + ציד תמונות!' },
  morocco:     { name:'מרוקו',       emoji:'🇲🇦', accommodation:{low:80,mid:210,high:515},  food:{low:60,mid:155,high:310},  transport:{low:45,mid:105,high:260}, activities:{low:55,mid:145,high:360},   flights:1200, visa:0,    insurancePer30:290, note:'הכי קרוב לישראל! סהרה + מדינות + תבלינים' },
  madagascar:  { name:'מדגסקר',      emoji:'🇲🇬', accommodation:{low:90,mid:260,high:670},  food:{low:55,mid:145,high:330},  transport:{low:75,mid:205,high:570}, activities:{low:85,mid:225,high:620},   flights:4200, visa:110,  insurancePer30:400, note:'למורים + ג׳ונגל + חיות שאין בשום מקום!' },
  usa:         { name:'ארה"ב',       emoji:'🇺🇸', accommodation:{low:210,mid:515,high:1240},food:{low:135,mid:290,high:620}, transport:{low:105,mid:260,high:620},activities:{low:105,mid:260,high:720},  flights:3500, visa:60,   insurancePer30:620, note:'הכי יקר — Road Trip חוסך הרבה!' },
};
