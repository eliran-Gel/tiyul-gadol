...
var BUDGET_DATA = {
  ...
  cambodia:    { name:'קמבודיה',    emoji:'🇰🇭', accommodation:{low:60,mid:150,high:400}, food:{low:45,mid:120,high:250}, transport:{low:40,mid:90,high:200},  activities:{low:50,mid:130,high:300}, flights:2900, visa:90,   insurancePer30:350 },
  ...
  nepal:       { name:'נפאל',       emoji:'🇳🇵', accommodation:{low:55,mid:140,high:350}, food:{low:40,mid:110,high:260}, transport:{low:35,mid:90,high:220},  activities:{low:100,mid:250,high:600},flights:2500, visa:150,  insurancePer30:350 },
  ...
  costarica:   { name:'קוסטה ריקה', emoji:'🇨🇷', accommodation:{low:115,mid:310,high:775},food:{low:85,mid:205,high:465},transport:{low:65,mid:175,high:465}, activities:{low:125,mid:310,high:775},flights:3600, visa:0,    insurancePer30:380 },
  ...
  newzealand:  { name:'ניו זילנד',  emoji:'🇳🇿', accommodation:{low:210,mid:465,high:1030},food:{low:125,mid:260,high:515},transport:{low:105,mid:260,high:620},activities:{low:155,mid:360,high:825},flights:5500, visa:130,  insurancePer30:580 },
  kenya:       { name:'קניה',       emoji:'🇰🇪', accommodation:{low:105,mid:310,high:825},food:{low:65,mid:155,high:360},transport:{low:55,mid:155,high:415}, activities:{low:210,mid:515,high:1550},flights:2500, visa:150,  insurancePer30:420 },
  tanzania:    { name:'טנזניה',     emoji:'🇹🇿', accommodation:{low:125,mid:360,high:1240},food:{low:75,mid:185,high:415},transport:{low:75,mid:205,high:620}, activities:{low:310,mid:775,high:2320},flights:2500, visa:150,  insurancePer30:420 },
  uganda:      { name:'אוגנדה',     emoji:'🇺🇬', accommodation:{low:125,mid:360,high:1240},food:{low:75,mid:185,high:415},transport:{low:90,mid:245,high:620}, activities:{low:415,mid:930,high:2480},flights:2800, visa:150,  insurancePer30:410 },
  southafrica: { name:'דרום אפריקה',emoji:'🇿🇦', accommodation:{low:115,mid:310,high:930},food:{low:85,mid:205,high:465},transport:{low:85,mid:225,high:620}, activities:{low:125,mid:360,high:1035},flights:3000, visa:0,    insurancePer30:400 },
  namibia:     { name:'נמיביה',     emoji:'🇳🇦', accommodation:{low:115,mid:310,high:930},food:{low:70,mid:175,high:390},transport:{low:85,mid:260,high:720}, activities:{low:105,mid:310,high:825}, flights:3200, visa:0,    insurancePer30:400 },
...
// Test 3: Uganda 14 days high — gorilla permits inflate activities a lot
(function() {
  console.log('\n[3] Uganda 14 days high');
  var r = calculate('uganda', 14, 'high');
  assert('activities dominant', r.activities, 20000, 50000);
  assert('total', r.total, 30000, 80000);
})();
...
(function() {
  ...
  assert('activities reflect trekking', r.activities, 15000, 35000);
  assert('total', r.total, 35000, 75000);
})();
